        ...
        if action in ('play','search'):
            ...
            if kind in ('track','artist','album') or not kind:
                ...
                if resolution['status']!='matched':
                    ...
                    return resolution
                data={'entity_id':player,'media_id':resolution['match']['uri'],'enqueue':'replace','media_type':kind}
            elif action=='search':
